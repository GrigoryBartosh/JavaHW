...
public class Unzipper {
     ...
     */
    private static ArrayList<File> findArchives(String path) throws IOException {
     ...
     */
    private static void unzipEntry(ZipEntry entry, File file, String destination) throws IOException {
