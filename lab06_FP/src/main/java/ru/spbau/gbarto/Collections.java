...
public class Collections {
    ...
    private static <T, U> U foldrHelper(@NotNull Function2<? super T, ? super U, ? extends U> f, @NotNull U ini, @NotNull Iterator<? extends T> it) {
        if (it.hasNext()) {
    ...
    public static <T, U> U foldr(@NotNull Function2<? super T, ? super U, ? extends U> f, @NotNull U ini, @NotNull Iterable<? extends T> l) {
        return foldrHelper(f, ini, l.iterator());
    }
