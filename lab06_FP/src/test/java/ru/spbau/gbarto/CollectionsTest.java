...
public class CollectionsTest {
    @Test
    public void mapSquare() throws Exception {
    ...
    @Test
    public void filterSquareLess() throws Exception {
    ...
    @Test
    public void takeWhileSquareLess() throws Exception {
        Predicate<Integer> f = new Predicate<Integer>() {
            @Override
            public Boolean apply(Integer x) {
                return x * x < 1000;
    ...
    @Test
    public void takeUnlessSquareLess() throws Exception {
        Predicate<Integer> f = new Predicate<Integer>() {
            @Override
            public Boolean apply(Integer x) {
                return x * x < 1000;
    ...
    @Test
    public void foldrExponentiation() throws Exception {
    ...
    @Test
    public void foldlExponentiation() throws Exception {
        Function2<Integer, Integer, Integer> f = new Function2<Integer, Integer, Integer>() {
            @Override
            public Integer apply(Integer x, Integer y) {
                return (int)pow(x, y);
